...
func TestSpecIpv6ConfigRTXSyntax(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:       "rtadv_multi_prefix",
			rtxCommand: `ipv6 lan1 rtadv send 1 2`,
			parseOnly:  false,
			buildOnly:  false,
		},
		{
			name:       "rtadv_multi_prefix_full",
			rtxCommand: `ipv6 lan1 rtadv send 1 2 o_flag=on m_flag=off lifetime=1800`,
			parseOnly:  false,
			buildOnly:  false,
		},
		{
...
func TestSpecIpv6ConfigRTXTerraformMapping(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			name:          "rtadv_basic",
			rtxCommand:    `ipv6 lan1 rtadv send 1`,
			terraformJSON: `{"interface":"lan1","rtadv":{"prefix_ids":[1]}}`,
			parseOnly:     false,
			buildOnly:     false,
		},
		{
			name:          "rtadv_with_o_flag",
			rtxCommand:    `ipv6 lan1 rtadv send 1 o_flag=on`,
			terraformJSON: `{"interface":"lan1","rtadv":{"o_flag":true,"prefix_ids":[1]}}`,
			parseOnly:     false,
			buildOnly:     false,
		},
		{
			name:          "rtadv_with_m_flag",
			rtxCommand:    `ipv6 lan1 rtadv send 1 m_flag=on`,
			terraformJSON: `{"interface":"lan1","rtadv":{"m_flag":true,"prefix_ids":[1]}}`,
			parseOnly:     false,
			buildOnly:     false,
		},
		{
			name:          "rtadv_with_lifetime",
			rtxCommand:    `ipv6 lan1 rtadv send 1 lifetime=1800`,
			terraformJSON: `{"interface":"lan1","rtadv":{"prefix_ids":[1],"router_lifetime":1800}}`,
			parseOnly:     false,
			buildOnly:     false,
		},
		{
			name:          "rtadv_full",
			rtxCommand:    `ipv6 lan1 rtadv send 1 o_flag=on m_flag=off lifetime=3600`,
			terraformJSON: `{"interface":"lan1","rtadv":{"m_flag":false,"o_flag":true,"prefix_ids":[1],"router_lifetime":3600}}`,
			parseOnly:     false,
			buildOnly:     false,
		},
		{
			name:          "rtadv_multi_prefix",
			rtxCommand:    `ipv6 lan1 rtadv send 1 2`,
			terraformJSON: `{"interface":"lan1","rtadv":{"prefix_ids":[1,2]}}`,
			parseOnly:     false,
			buildOnly:     false,
		},
		{
			name:          "rtadv_multi_prefix_full",
			rtxCommand:    `ipv6 lan1 rtadv send 1 2 o_flag=on m_flag=off lifetime=1800`,
			terraformJSON: `{"interface":"lan1","rtadv":{"m_flag":false,"o_flag":true,"prefix_ids":[1,2],"router_lifetime":1800}}`,
			parseOnly:     false,
			buildOnly:     false,
		},
		{
