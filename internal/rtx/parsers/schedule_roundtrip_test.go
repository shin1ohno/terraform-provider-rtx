// Hand-maintained. Despite the header this file carried until 0.16.4, nothing
// in tools/ emits *_roundtrip_test.go — specgen only writes <name>_spec_test.go
// — so edit this file directly; regenerating from specs/schedule/config.yaml
// will not touch it.
//
// Round-trip coverage of RTX <-> Terraform conversion through the real parsers.
