...
// TestSpecBridgeConfigModelCompatibility tests router model compatibility
func TestSpecBridgeConfigModelCompatibility(t *testing.T) {
	...
	for _, model := range supportedModels {
		t.Run("supported_"+model, func(t *testing.T) {
			if !IsModelSupported("bridge_config", model) {
				t.Errorf("Model %s should be supported for bridge_config", model)
			}
		})
	}
	...
	for _, model := range unsupportedModels {
		t.Run("unsupported_"+model, func(t *testing.T) {
			if IsModelSupported("bridge_config", model) {
				t.Errorf("Model %s should NOT be supported for bridge_config", model)
			}
		})
	}
}
