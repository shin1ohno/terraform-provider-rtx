...
```bash
# Linux/macOS
mkdir -p ~/.terraform.d/plugins/registry.terraform.io/shin1ohno/rtx/0.12.0/linux_amd64
unzip terraform-provider-rtx_0.12.0_linux_amd64.zip -d ~/.terraform.d/plugins/registry.terraform.io/shin1ohno/rtx/0.12.0/linux_amd64
```
