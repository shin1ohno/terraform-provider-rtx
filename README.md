...
```bash
# Linux/macOS
mkdir -p ~/.terraform.d/plugins/registry.terraform.io/shin1ohno/rtx/0.16.4/linux_amd64
unzip terraform-provider-rtx_0.16.4_linux_amd64.zip -d ~/.terraform.d/plugins/registry.terraform.io/shin1ohno/rtx/0.16.4/linux_amd64
```
