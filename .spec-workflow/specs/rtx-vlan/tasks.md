...
- [ ] 1. Create VLAN data model and parser
...
- [ ] 2. Create command builder functions for VLAN
...
- [ ] 4. Add VLAN type to client interfaces
...
- [ ] 5. Create VLANService implementation
...
- [ ] 6. Integrate VLANService into rtxClient
