...
- [x] 1. Extend Config struct with SSH key authentication fields
...
- [x] 2. Implement SSH key authentication in ssh_dialer.go
...
- [x] 3. Add provider schema attributes for SSH key authentication
...
- [x] 4. Extend SSHDConfig struct with AuthMethod field
  - File: internal/client/interfaces.go
...
- [x] 5. Add auth method commands to parsers
...
- [x] 6. Update ServiceManager with auth method support
...
- [x] 7. Add auth_method attribute to rtx_sshd resource
...
- [x] 8. Add host key service methods to ServiceManager
  - File: internal/client/service_manager.go
...
- [x] 9. Add host key parser functions
  - File: internal/rtx/parsers/service.go
...
- [x] 10. Create rtx_sshd_host_key resource
...
- [x] 11. Add authorized keys service methods to ServiceManager
  - File: internal/client/service_manager.go
...
- [x] 12. Add authorized keys parser functions
  - File: internal/rtx/parsers/service.go
...
- [x] 13. Create rtx_sshd_authorized_keys resource
