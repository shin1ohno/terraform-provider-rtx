...
- [ ] 1. Create NATMasquerade data model and parser
...
- [ ] 2. Create command builder functions for NAT masquerade
...
- [ ] 4. Add NATMasquerade type to client interfaces
...
- [ ] 5. Create NATMasqueradeService implementation
...
- [ ] 6. Integrate NATMasqueradeService into rtxClient
