...
- [ ] 1. Create InterfaceConfig data model and parser
...
- [ ] 2. Create command builder functions for interface configuration
...
- [ ] 4. Add InterfaceConfig type to client interfaces
...
- [ ] 5. Create InterfaceService implementation
...
- [ ] 6. Integrate InterfaceService into rtxClient
