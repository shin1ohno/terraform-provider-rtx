# Tasks Document: State Drift Fix for Access List Resources

- [x] 1. Fix rtx_interface Read to preserve access list attributes
...
- [x] 2. Fix rtx_ipv6_interface Read to preserve access list attributes
...
- [x] 3. Add DiffSuppressFunc for ace_action in rtx_access_list_mac
...
- [x] 4. Fix address normalization in ethernet_filter_service
...
- [x] 5. Fix source/destination address vs any field handling
  - File: internal/provider/resource_rtx_access_list_mac.go
