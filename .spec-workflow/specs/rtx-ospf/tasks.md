...
- [ ] 1. Create OSPFConfig data model and parser
...
- [ ] 2. Create command builder functions for OSPF
...
- [ ] 4. Add OSPFConfig type to client interfaces
...
- [ ] 5. Create OSPFService implementation
...
- [ ] 6. Integrate OSPFService into rtxClient
