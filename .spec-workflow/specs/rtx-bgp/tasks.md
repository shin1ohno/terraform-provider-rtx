...
- [ ] 1. Create BGP data model and parser
...
- [ ] 2. Create command builder functions for BGP
...
- [ ] 4. Add BGPConfig type to client interfaces
...
- [ ] 5. Create BGPService implementation
...
- [ ] 6. Integrate BGPService into rtxClient
