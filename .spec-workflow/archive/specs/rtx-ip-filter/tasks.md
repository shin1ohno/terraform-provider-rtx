...
- [x] 1. Create IPFilter data model and parser
...
- [x] 2. Create command builder functions for IP filter
...
- [x] 3. Create IPv6 filter command builder functions
  - File: internal/rtx/parsers/ip_filter.go (continue)
...
- [x] 5. Add IPFilter types to client interfaces
...
- [x] 6. Create IPFilterService implementation
...
- [x] 7. Create IPFilterDynamicService implementation
...
- [x] 8. Integrate IPFilterService into rtxClient
...
- [x] 10. Create AccessListExtended Terraform resource schema
...
- [x] 11. Implement CRUD operations for AccessListExtended resource
...
- [x] 12. Create IPFilterDynamic Terraform resource
...
- [x] 13. Create IPv6 filter Terraform resources
...
- [x] 14. Create InterfaceACL Terraform resource
...
- [x] 15. Implement import functionality for all resources
  - File: internal/provider/resource_rtx_access_list_extended.go (continue)
...
- [x] 16. Register resources in provider
...
- [x] 17. Create resource unit tests
...
- [x] 19. Add example Terraform configurations
...
- [x] 20. Final integration testing and cleanup
