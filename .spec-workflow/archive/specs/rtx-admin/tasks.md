...
- [x] 1. Create AdminConfig data model and parser
...
- [x] 2. Create command builder functions for admin configuration
...
- [x] 4. Add Admin types to client interfaces
...
- [x] 5. Create AdminService implementation
...
- [x] 6. Integrate AdminService into rtxClient
...
- [x] 8. Create Terraform resource schema for rtx_admin
...
- [x] 9. Create Terraform resource schema for rtx_admin_user
...
- [x] 10. Implement CRUD operations for rtx_admin resource
...
- [x] 11. Implement CRUD operations for rtx_admin_user resource
...
- [x] 12. Implement import functionality for both resources
  - File: internal/provider/resource_rtx_admin.go (continue)
  - File: internal/provider/resource_rtx_admin_user.go (continue)
...
- [x] 13. Register resources in provider
...
- [x] 14. Create resource unit tests
...
- [x] 16. Add example Terraform configurations
