...
- [x] 1. Create IPv6Prefix data model and parser
...
- [x] 2. Create command builder functions for IPv6 prefix
...
- [x] 4. Add IPv6Prefix type to client interfaces
...
- [x] 5. Create IPv6PrefixService implementation
...
- [x] 6. Integrate IPv6PrefixService into rtxClient
