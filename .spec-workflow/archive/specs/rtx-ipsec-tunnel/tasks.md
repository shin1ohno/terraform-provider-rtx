...
- [x] 1. Create IPsecTunnel data model and parser
...
- [x] 2. Create command builder functions for IPsec tunnel
...
- [x] 4. Add IPsecTunnel types to client interfaces
...
- [x] 5. Create IPsecTunnelService implementation
...
- [x] 6. Integrate IPsecTunnelService into rtxClient
