...
- [x] 1. Create DNS data model and parser
...
- [x] 2. Create command builder functions for DNS
...
- [x] 4. Add DNS types to client interfaces
...
- [x] 5. Create DNSService implementation
...
- [x] 6. Integrate DNSService into rtxClient
