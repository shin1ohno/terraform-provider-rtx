...
- [x] 1. Create SystemConfig data model and parser
...
- [x] 2. Create command builder functions for system configuration
...
- [x] 4. Add SystemConfig type to client interfaces
...
- [x] 5. Create SystemService implementation
...
- [x] 6. Integrate SystemService into rtxClient
