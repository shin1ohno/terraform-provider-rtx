...
- [x] 1. Create EthernetFilter data model and parser
...
- [x] 2. Create command builder functions for Ethernet filter
...
- [x] 4. Add EthernetFilter type to client interfaces
...
- [x] 5. Create EthernetFilterService implementation
...
- [x] 6. Integrate EthernetFilterService into rtxClient
...
- [x] 11. Create interface MAC ACL binding resource
