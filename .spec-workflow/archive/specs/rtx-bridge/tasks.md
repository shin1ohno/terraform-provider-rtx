...
- [x] 1. Create BridgeConfig data model and parser
...
- [x] 2. Create command builder functions for bridge
...
- [x] 4. Add BridgeConfig type to client interfaces
...
- [x] 5. Create BridgeService implementation
...
- [x] 6. Integrate BridgeService into rtxClient
