...
- [x] 1. Create SyslogConfig data model and parser
...
- [x] 2. Create command builder functions for syslog
...
- [x] 4. Add SyslogConfig type to client interfaces
...
- [x] 5. Create SyslogService implementation
...
- [x] 6. Integrate SyslogService into rtxClient
