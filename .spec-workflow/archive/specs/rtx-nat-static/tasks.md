...
- [x] 1. Create NATStatic data model and parser
...
- [x] 2. Create command builder functions for static NAT
...
- [x] 4. Add NATStatic type to client interfaces
...
- [x] 5. Create NATStaticService implementation
...
- [x] 6. Integrate NATStaticService into rtxClient
