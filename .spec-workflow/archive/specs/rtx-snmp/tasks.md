...
- [x] 1. Create SNMPConfig data model and parser
...
- [x] 2. Create command builder functions for SNMP
...
- [x] 4. Add SNMPConfig type to client interfaces
...
- [x] 5. Create SNMPService implementation
...
- [x] 6. Integrate SNMPService into rtxClient
...
- [x] 8. Create Terraform resource schema for rtx_snmp_server
...
- [x] 9. Implement CRUD operations for rtx_snmp_server resource
...
- [x] 10. Implement import functionality for rtx_snmp_server
  - File: internal/provider/resource_rtx_snmp_server.go (continue)
