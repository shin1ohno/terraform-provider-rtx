...
- [x] 1. Create IPv6InterfaceConfig data model and parser
...
- [x] 2. Create command builder functions for IPv6 interface
...
- [x] 4. Add IPv6InterfaceConfig type to client interfaces
...
- [x] 5. Create IPv6InterfaceService implementation
...
- [x] 6. Integrate IPv6InterfaceService into rtxClient
