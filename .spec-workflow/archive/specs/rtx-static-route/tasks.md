...
- [x] 1. Create StaticRoute data model and parser
...
- [x] 2. Create command builder functions for static routes
...
- [x] 4. Add StaticRoute type to client interfaces
...
- [x] 5. Create StaticRouteService implementation
...
- [x] 6. Integrate StaticRouteService into rtxClient
